package br.com.example.kafka.configurations;
...
public class KafkaConfig {
	...
	public ProducerFactory<String, ShopDTO> producerFactory() {
		...
		props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapAddress);// endereço do Kafka
		props.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class); // tipo de chave
		props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JsonSerializer.class);// define o tipo de envio de dados para comunicação com o Kafka nesse exemplo foi optado pelo JSON
		props.put(ProducerConfig.CLIENT_ID_CONFIG, "shop-api"); // define o identificador para o produtor
